...
# 24 "/usr/lib/clang/18/include/__stddef_wchar_t.h" 3 4
typedef int wchar_t;
...
void err(int status, str string);
# 5 "libs/parser.h" 2
# 1 "libs/./lexer.h" 1
...
# 7 "libs/./lexer.h" 2
# 1 "/usr/lib/clang/18/include/stdint.h" 1 3
# 52 "/usr/lib/clang/18/include/stdint.h" 3
...
# 53 "/usr/lib/clang/18/include/stdint.h" 2 3
# 8 "libs/./lexer.h" 2
...
struct Type {
  enum {
    t_i8, ptr_i8, t_i16, ptr_i16, t_i32, ptr_i32, t_i64, ptr_i64, t_i128, ptr_i128, t_u8, ptr_u8, t_u16, ptr_u16, t_u32, ptr_u32, t_u128, ptr_u128, t_f16, ptr_f16, t_f32, ptr_f32, t_f64, ptr_f64, t_f128, ptr_f128, t_str, ptr_str, t_char, ptr_char,
  } variant;
  union {
    struct {
      struct Type *elem;
...
static char *str_types[] = {
  "i8", "i16", "i32", "i64", "i128", "u8", "u16", "u32", "u128", "f16", "f32", "f64", "f128", "str", "char",
};
static type_t type_pairs[] = {
  (type_t) {"i8", t_i8}, (type_t) {"i16", t_i16}, (type_t) {"i32", t_i32}, (type_t) {"i64", t_i64}, (type_t) {"i128", t_i128}, (type_t) {"u8", t_u8}, (type_t) {"u16", t_u16}, (type_t) {"u32", t_u32}, (type_t) {"u128", t_u128}, (type_t) {"f16", t_f16}, (type_t) {"f32", t_f32}, (type_t) {"f64", t_f64}, (type_t) {"f128", t_f128}, (type_t) {"str", t_str}, (type_t) {"char", t_char},
  (type_t) {"ptr_i8", ptr_i8}, (type_t) {"ptr_i16", ptr_i16}, (type_t) {"ptr_i32", ptr_i32}, (type_t) {"ptr_i64", ptr_i64}, (type_t) {"ptr_i128", ptr_i128}, (type_t) {"ptr_u8", ptr_u8}, (type_t) {"ptr_u16", ptr_u16}, (type_t) {"ptr_u32", ptr_u32}, (type_t) {"ptr_u128", ptr_u128}, (type_t) {"ptr_f16", ptr_f16}, (type_t) {"ptr_f32", ptr_f32}, (type_t) {"ptr_f64", ptr_f64}, (type_t) {"ptr_f128", ptr_f128}, (type_t) {"ptr_str", ptr_str}, (type_t) {"ptr_char", ptr_char},
};
static type_t lft_pairs[] = {
  (type_t) {"const", t_const}, (type_t) {"comptime", t_comptime}, (type_t) {"static", t_static},
};
